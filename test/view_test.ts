...
import {View, IEventMap} from '../src/viking/view';
...
//     });
    ...
    it('#986 - Undelegate before changing element.', () => {
        ...
        (button1 as any).click();
        (button2 as any).click();
    ...
    it('remove', () => {
        ...
        myView.delegate('click', function() { assert.ok(false); });
        myView.addEventListenerFor(myView, ['*', 'x'], function() { assert.ok(false); });
