# Copied from https://github.com/rails/rails/blob/master/railties/lib/rails/source_annotation_extractor.rb
# so that rails deps don't interfear with sprockets
#
