...
export default class Model extends EventBus {
    ...
    /**
     * Applies the default and initial attributes to a newly constructed instance.
     * Subclasses (e.g. {@link Record}) override this to set up additional state,
     * such as associations, before delegating back via `super.initialize`.
     * @param {Object} attributes - The attributes to apply
     * @param {Object} options - Construction options
     */
    initialize(attributes, options) {
        this.setDefaultAttributes(attributes);
        this.applyAttributes(attributes, options);
    }

    /**
     * Applies the initial attributes to the instance. Subclasses override this to
     * apply more than plain attributes (e.g. {@link Record} also applies
     * associations via `setAttributesAndAssociations`).
     * @param {Object} attributes - The attributes to apply
     * @param {Object} options - Construction options
     */
