...
import * as array from './support/array.js';
import * as boolean from './support/boolean.js';
import * as date from './support/date.js';
import * as number from './support/number.js';
import * as object from './support/object.js';
import * as string from './support/string.js';
import * as klass from './support/class.js';

export {deepAssign, pick, isPlainObject} from './support/object.js';
...
export function toQuery(value, key) {
    ...
    if (typeof value === 'object') {
        return object.toQuery(value, {namespace: key});
    }
...
export function each(value, callback) {
    ...
    } else if (window.DataTransferItemList && value instanceof window.DataTransferItemList) {
