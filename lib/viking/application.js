...
export default class Application extends View {
  ...
  * @option {Function} layout - Override Application.layout
  * @option {String} title - Override Application.title
  * @return {Element(s)} - return of template
  */ 
  async display(template, locals={}, options={}) {
      const layoutTemplate = locals.layout || this.layout
      ...
      const title = locals.title || this.title;
      if (title !== undefined) {
