 ...
 * 
 * @example
 * class UserView extends Viking.View {
 *   static events = {
...
export default class View extends EventBus {
     ...
     * 
     * @return {Viking.View} The view instance for chaining
     */
    render() {
        return this;
    }
     ...
     * @return {Viking.View} The created subview instance
     */
     ...
     * the subViews array.
     * 
     * @param {Viking.View} view - The subview to remove
     */
    removeSubView(view) {
     ...
     * 
     * @param {Viking.View} view - The removed subview
     * @private
     */
    subViewRemoved(view) {
        this.subViews = this.subViews.filter((v) => v !== view);
