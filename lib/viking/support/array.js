...
/**
 * Ensures a value is an array by wrapping it if necessary.
 * If value is already an array, returns it unchanged; otherwise wraps
 * the value in an array. Unlike `Array.from`, which converts iterables
 * and array-likes, this wraps scalars (e.g. `toArray(5)` is `[5]`).
 *
