...
export function insertBefore(target, ...content) {
    content.flat().forEach((child) => {
        if (typeof child === 'string') {
            const holder = document.createElement('div')
            holder.insertAdjacentHTML('beforeend', child);
            insertBefore(target, ...Array.from(holder.childNodes))
        } else {
