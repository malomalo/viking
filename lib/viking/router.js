...
export default class Router extends EventBus {
    ...
    /**
     * Set the current URL query string, replacing any existing one.
     *
     * @param {Object} [params] - Query parameters to set on the current URL
     * @param {Object} [options] - Options passed to toParam (`namespace`, `removeBlanks`)
     */
    setSearch(params, options) {
        const url = window.location.pathname + "?" + toParam(params, options);
