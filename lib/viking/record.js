...
export default class Record extends EventBus {
    ...
    commit (options) {
        ...
        const path   = this.constructor.connection.path(wasNew ? this.constructor : this);
    ...
    async reload(options = {}) {
        ...
        return await this.constructor.connection[method](this.constructor.connection.path(this), this.optionsForSync('reload', options));
    }
    ...
    async destroy(options = {}) {
        ...
        await this.constructor.connection[method](this.constructor.connection.path(this)).then(() => {
            /**
