...
//         }
    ...
    async save(options = {}) {
        ...
        return await this.constructor.connection[method](path, this.optionsForSave('save', options));
    }
    ...
    async reload(options = {}) {
        ...
        return await this.constructor.connection.get(this.url(), this.optionsForSave('reload', options));
    }
