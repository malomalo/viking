...
export default class Record extends Model {
    ...
    /**
     * Sets attributes, routing any association keys to their associations and
     * applying the rest via {@link Model#setAttributes}. Overrides
     * {@link Model#setAttributes} so associations passed at construction — and
     * anywhere else attributes are set — are resolved into association targets.
    ...
    /**
     * Sets both attributes and associations at once. Retained for callers that
     * name the association-aware form explicitly; {@link Record#setAttributes}
     * now routes associations itself.
     * @param {Object} attributes - Object containing attributes and associations to set
     * @param {Object} [options={}]
     * @returns {Object} The attribute changes
     */
