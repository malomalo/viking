...
export default class Record extends EventBus {
    ...
    commit (options) {
        ...
        const sendRequest = () => {
            this._savingRequest = this.constructor.connection[action](path, options)
    ...
    async reload(options = {}) {
        ...
        return await this.constructor.connection.read(this.constructor.connection.path(this), this.optionsForSync('reload', options));
    }
    ...
    async destroy(options = {}) {
        ...
        await this.constructor.connection.destroy(this.constructor.connection.path(this)).then(() => {
            /**
