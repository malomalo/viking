...
//         }
    ...
    needsSaved() {
        return (this.hasChanged() || Object.values(this._associations).some(a => a.needsSaved()));
    }
        ...
        each(attributes, (key, value) => {
            if (this._associations.hasOwnProperty(key)) {
                ...
                if (value instanceof Record) {
                    ...
                    console.log(key, value, association);
    ...
    attributesForSave(options) {
        ...
        each(this._associations, (name, association) => {
            if (association.needsSaved()) {
                attributes[`${association.reflection.name}_attributes`] = association.attributesForSave();
            }
        });
