...
export default class Connection {
    ...
    sendRequest(method, path, {params = null, body = null, headers = {}, success = null, invalid = null, error = null, progress = null} = {}) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.addEventListener('load', () => {
                ...
                if (request.status >= 200 && request.status <= 299) {
                    ...
                    let return_value = invalid(request, error_callback);
