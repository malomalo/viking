...
export default class Association extends EventBus {
    ...
    addBang(record, options={}) {
        ...
        if (record.isPersisted()) {
            ...
            const path = this.reflection.model.connection.associationPath(this.owner, this.reflection.name);
    ...
    sendResourceRequest(record, options) {
        const path = this.reflection.model.connection.associationPath(this.owner, this.reflection.name, record);
