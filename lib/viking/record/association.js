 ...
 * @memberof Viking
 * @extends EventBus
 * @param {Viking.Record} owner - The parent record that owns this association
 * @param {Viking.Record.Reflection} reflection - The reflection that defines this association
 *
 */
...
export default class Association extends EventBus {
     ...
     * 
     * @return {Viking.Association} A new association instance with cloned targets
     */
    clone () {
     ...
     * 
     * @param {Viking.Record} record - The record to add to the association
     ...
     * 
     * @param {Viking.Record} record - The record to remove from the association
     * @param {Object} [options={}] - Options to pass to the request
     ...
     * 
     * @param {Viking.Record} record - The record to send the request for
     * @param {Object} options - Options to pass to the request
