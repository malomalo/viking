...
export default class Association extends EventBus {
    ...
    addBang(record, options={}) {
        ...
        if (!options.label) { options.label = this.owner.modelName.name + '.'+this.reflection.name+'['+this.cid+'].addBang'}
    ...
    removeBang(record, options={}) {
        ...
        if (!options.label) { options.label = this.owner.modelName.name + '.'+this.reflection.name+'['+this.cid+'].removeBang'}
    ...
    reload({label=null}={}) {
        ...
        this.loaded = false;
        if (!label) { label = this.owner.modelName.name + '.'+this.reflection.model.modelName.name+'['+this.cid+'].reload'}
