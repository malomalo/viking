...
export default class Relation extends EventBus {
    ...
    */
     ...
     *
     * If `options.extension` is provided it is plucked from the options
     * and used to append a file extension to the path (e.g. `"csv"`)
     * before the query string is appended.
     *
     * @instance
     * @param {Object} [options={}] Param overrides merged over the generated
     *                              query params. `extension` is plucked
     *                              and converted to a path extension.
     * @return {string}
     */
    toPath(options = {}) {
        const { extension, ...paramOverrides } = options;
