...
/**
 * The beforeLoad event.
 * @event Viking#beforeLoad
 * @type {Viking.Record[]}
 */

/**
 * The beforeLoad event.
 * @event Viking#beforeSetTarget
 * @type {Viking.Record}
 */

/**
 * The beforeLoad event.
 * @event Viking#afterAdd
 * @type {Viking.Record}
 */

/**
 * The beforeLoad event.
 * @event Viking#afterRemove
 * @type {Viking.Record}
 */

/**
 * The beforeLoad event.
 * @event Viking#afterLoad
 * @type {Viking.Record}
 */
...
export default class Relation extends EventBus {
     ...
     *
     * If the relation is loaded the loaded relation will be returned. Use `reload`
     * to reload the relation if you wish to fetch it from the server again.
     *
     ...
     *
     * @fires Viking#beforeLoad     called before sending the request to load
                                    the records to the server. This will *not*
                                    be called if the relation is already loaded.
     * @fires Viking#beforeSetTarget    called before setting the new records
                                        on the relation.
     * @fires Viking#afterAdd       called for every record that is added to the
                                    relation. Will *not* be called for any records
                                    already in memory.
     * @fires Viking#afterRemove    called for every record that is removed from
                                    the relation that was not in the response.
     * @fires Viking#afterLoad      called once relation has been loaded.
     */
   ...
   /**
    * Sets the records of this relation, removing and adding records as needed.
    *
    * @param  {Viking.Record[]} records
    *
    * @fires Viking#beforeSetTarget     called before setting the new target
    * @fires Viking#afterAdd            called for every record that is added
    * @fires Viking#afterRemove         called for every record that is removed
    */
