...
export default class FormBuilder {
    ...
    constructor(model, options) {
        ...
        modelName = options?.as || this.model.baseClass.modelName.paramKey;
    ...
    submit(value = null, options = {}) {
        ...
        if (!value) {
            value = this.model.isNewRecord() ? 'Create' : 'Update';
        }
            ...
            return _.map(records, function (model) {
                ...
                if (!options.namespace) {
                    if (superOptions.namespace) {
                        ...
                        localOptions.namespace = parentModel.baseClass.modelName.paramKey + '[' + attribute + '][' + model.cid + ']';
                    }
                }
