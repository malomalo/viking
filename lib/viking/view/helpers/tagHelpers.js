...
import { each, result } from 'viking/support';
import { last } from 'viking/support/array';
import { escape as escapeHTML } from 'viking/support/escape';
import Model from 'viking/record';
...
export function tag(name, options, escape) {
    var t = document.createElement(name);
    setTagOptions(t, options, escape);
    return t;
};
...
export function contentTag(name, content, options, escape = true) {
    let tmp;
...
export function tagOption(key, value, escape) {
...
export function setTagOptions(el, options, escape) {
...
export function dataTagOption(key, value, escape) {
    key = "data-" + key;
...
export function checkBoxTag(name, value = '1', checked, options = {}, escape = true) {
...
export function labelTag(content, options, escape = true) {
    var tmp;
...
export function textFieldTag(name, value, options, escape = true) {
...
export function hiddenFieldTag(name, value, options = {}, escape = true) {
...
export function textAreaTag(name, content, options = {}, escape = true) {
    ...
    if (escape) { content = escapeHTML(content); }
